...
/// rather than measuring anything: an implementation of this interface opens
/// no connection, and one that measured an upload by performing one would
/// break the promise the whole disclosure wave is built on. What Windows
/// does inside its own service to answer is Windows' business, and not
/// something brisk has watched.
