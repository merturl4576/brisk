...
Tek satır — ama güvenmek zorunda kalma diye betik [35 okunur satır](get.ps1): son sürümü indirir, **SHA-256 özeti yayımlananla tutmuyorsa çalıştırmayı reddeder** ve tek klasöre açar (kaldırmak = klasörü silmek):
