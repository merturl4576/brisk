...
#
# No invented-parent list here, unlike the storage-sense and visual-effects
# plants: this plant creates no keys at all. It removes one value and writes
# another that already exists. A list of levels that merely happened to be
# missing would license the restore to delete keys somebody else created during
# the planted window - a GPO refresh landing an Explorer policy key is the
# realistic loser - and a key we did not make is not ours to remove.
